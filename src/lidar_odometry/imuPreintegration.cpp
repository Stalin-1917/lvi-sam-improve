...
public:
    ...
    void imuOdometryHandler(const nav_msgs::Odometry::ConstPtr &odomMsg)
    {
        ...
        Eigen::Affine3f imuOdomAffineIncre = imuOdomAffineFront.inverse() * imuOdomAffineBack;//odom变换
        Eigen::Affine3f imuOdomAffineLast = lidarOdomAffine * imuOdomAffineIncre;//雷达估计的odom
        float x, y, z, roll, pitch, yaw;
        pcl::getTranslationAndEulerAngles(imuOdomAffineLast, x, y, z, roll, pitch, yaw);//根据仿射矩阵计算x,y,z,roll,pitch,yaw
...
public:
    ...
    void odometryHandler(const nav_msgs::Odometry::ConstPtr &odomMsg)
    {
        ...
        // 2. after optiization, re-propagate imu odometry preintegration 预积分
